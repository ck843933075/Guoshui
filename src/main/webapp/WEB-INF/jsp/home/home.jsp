        ...
        <td width="331" align="right" valign="top">
            <table width="350" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="left"></td>
                    <td align="right">
                        <a><b></b><font color="red">欢迎您，${user.UName}&nbsp;</font></a>
                    </td>
                    ...
                    <td align="left" valign="middle" ><a href="${ctx }/sys/logoutUI.action">退出</a></td>
                </tr>
            </table>
        </td>
    </tr>
            ...
            <table width="98%" border="0" align="center">
                <tr>
                    <td width="76" height="100" align="center" valign="middle">
                        <div class="left-tx">
                            <%-- <s:if test="%{user.UPhoto }">
                            	<img src="${ctx}/upload/${user.UPhoto}" width="70" height="70" />
                            </s:if><s:else>
                    ...
                    <td width="60%"><table width="95%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="2" style=" font-weight:bold; color:#3a7daa;">${user.UName }</td>
                           
                        </tr>
                        <tr>
                            <td colspan="2">所属部门：${user.dept.DName }</td>
                        </tr>
                    </table>
                    </td>
                </tr>
    ...
    <div class="right">
        <div class="left_grzx1">
            ...
            <table width="98%" border="0" align="center">
                ...
                <tr>
                    <td height="23">
                    <s:url var="infoViewUrl" action="infoViewUI" namespace="/home" >
                    	<s:param name="infoId"><s:property value="infoId"/></s:param>
                    </s:url>
                    <s:a href="%{#infoViewUrl}" target="_blank">
                    	<s:property value="ITitle"/>
                   	</s:a>
                    </td>
                    <td width="150px"><s:property value="infoType.ITypeName"/></td>
                    <td width="150px"><s:property value="user.UName"/></td>
                    <td width="150px"><s:date name="ICreateTime" format="yyyy-MM-dd HH:mm:ss"/></td>
                </tr>
                </s:iterator>
            </table>
        </div>
        ...
        <div class="lc_grzx1">
            <div class="lc_grzxbt">
                ...
                <div style="float:right;padding-top:3px;">
                	<s:a action="complainAddUI" namespace="/home/complain" target="_blank">我要投诉</s:a>&nbsp;&nbsp;
                </div>
            </div>
            <table width="98%" border="0" align="center" >
                ...
                <tr>
                    <td height="23">
                    <s:url var="complainViewUrl" action="complainViewUI" namespace="/home" >
                    	<s:param name="CId"><s:property value="CId"/></s:param>
                    </s:url>
                    <s:a href="%{#complainViewUrl}" target="_blank">
                    	<s:property value="CTitle"/>
                   	</s:a>
                    </td>
                    <td width="180px"><s:property value="complainStatusMap[CStatus]"/></td>
                    <td width="180px"><s:property value="CIsnm==1?'匿名投诉':'非匿名投诉'"/></td>
                    <td width="180px"><s:date name="CTime" format="yyyy-MM-dd HH:mm:ss"/></td>
                </tr>
                </s:iterator>
            </table>
        </div>
